...
export const Footer = () => {
  return (
    <>
      <section
        className="relative w-[90%] mx-auto py-3 xl:py-0  xl:h-[370px] rounded-[20px] sm:flex justify-center items-center px-5 sm:px-10 z-50 mt-10"
        style={{
      ...
      >
        <div>
          <Typography variant="h2Heading" color="white" className="mt-3">
            Don't Miss A Thing
          </Typography>
          <Typography
            variant="mainBodyPara"
            className="xl:w-[60%] mt-3"
            color="white"
          >
            Get essential travel tips, destination inspiration, itineraries, and
            the best places to stay in your inbox.
          </Typography>
          <Typography
            variant="mainBodyPara"
        ...
        <div className="flex flex-col gap-5 mt-10 sm:mt-0">
          <input
            ...
            className="border border-white text-white px-8 py-3 rounded-[20px] sm:w-[400px] w-full font-bodsy"
          />
          <input
            type="email"
            placeholder="Email"
            className="border border-white text-white px-8 py-3 rounded-[20px] sm:w-[400px] w-full font-body"
          />
          ...
          <div>
            ...
            <Link to="/about">
              <Typography
                variant="mainBodyPara"
                color="secondary"
                className="mt-2 text-textSecondary cursor-pointer hover:text-primary transition-colors"
              >
                About Us
              </Typography>
            </Link>
            <Link to="/services">
              <Typography
                variant="mainBodyPara"
                color="secondary"
                className="mt-1 text-textSecondary cursor-pointer hover:text-primary transition-colors"
              >
                Services
              </Typography>
            </Link>
