...
export const Hero = () => {
    return (
         <div
            className="bg-secondary h-[100%] w-[98%] mx-auto 2xl:h-[1080px] gap-5 bg-cover bg-no-repeat sm:px-12 sm:pt-56 pt-12 rounded-[20px]"
            style={{
          ...
          >
            ...
            <Typography variant="h1Heading" color='white' className='mt-8'>
             ...
             <Typography color='white' className='w-[900px] mt-8 pb-5'>
